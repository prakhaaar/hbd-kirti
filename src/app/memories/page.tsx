...
export default function MemoriesPage() {
  return (
    <main
      className={`min-h-screen bg-gradient-to-br from-[#f8d1ff] to-[#ffe5ec] flex flex-col items-center justify-center py-10 px-4 text-[#6a0dad] ${sans.className}`}
    >
      <motion.h1
        initial={{ opacity: 0, y: -30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
        className={`text-4xl md:text-5xl text-center mb-8 drop-shadow-xl ${cursive.className}`}
      >
        Mirror of Memories 🪞
      </motion.h1>
